...
//TIM3输出比较通道1
#define     TPAD_TIM_CH1_GPIO_CLK          RCC_APB2Periph_GPIOA
#define     TPAD_TIM_CH1_GPIO_PORT         GPIOA
#define     TPAD_TIM_CH1_GPIO_PIN          GPIO_Pin_1
#define     TPAD_TIM_CH1_CHANNNEL_x        TIM_Channel_2
