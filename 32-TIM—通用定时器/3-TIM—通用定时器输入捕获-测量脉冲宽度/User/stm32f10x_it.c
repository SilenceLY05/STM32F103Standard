...
void GENERAL_TIM_INT_FUN(void)
{
	...
	if(TIM_GetFlagStatus(GENERAL_TIM,TIM_IT_Update) != RESET)
	{
	...
	//上升沿捕获中断
	if(TIM_GetFlagStatus(GENERAL_TIM,GENERAL_TIM_IT_CCx) != RESET)
	{
		//第一次捕获
		...
		else
		{
			...
			//当第二次捕获到下降沿之后，就把捕获边沿配置为上升沿，好开始新一轮的buhuo
