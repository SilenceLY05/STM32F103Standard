...
/* NRF2 GPIO引脚 */
#define NRF2_GPIO_ClockCmd     RCC_APB2PeriphClockCmd
#define NRF2_SPI_ClockCmd      RCC_APB1PeriphClockCmd
#define NRF2_SPIx              SPI2
#define NRF2_SPI_CLK           RCC_APB1Periph_SPI2

#define NRF2_SCK_GPIO_CLK      RCC_APB2Periph_GPIOB
#define NRF2_SCK_GPIO_PORT     GPIOB
#define NRF2_SCK_GPIO_PIN      GPIO_Pin_13

#define NRF2_MOSI_GPIO_CLK     RCC_APB2Periph_GPIOB
#define NRF2_MOSI_GPIO_PORT    GPIOB
#define NRF2_MOSI_GPIO_PIN     GPIO_Pin_15

#define NRF2_MISO_GPIO_CLK     RCC_APB2Periph_GPIOB
#define NRF2_MISO_GPIO_PORT    GPIOB
#define NRF2_MISO_GPIO_PIN     GPIO_Pin_14

#define NRF2_CSN_GPIO_CLK      RCC_APB2Periph_GPIOB
#define NRF2_CSN_GPIO_PORT     GPIOB
#define NRF2_CSN_GPIO_PIN      GPIO_Pin_8

#define NRF2_CE_GPIO_CLK       RCC_APB2Periph_GPIOC
#define NRF2_CE_GPIO_PORT      GPIOC
#define NRF2_CE_GPIO_PIN       GPIO_Pin_7

#define NRF2_IRQ_GPIO_CLK      RCC_APB2Periph_GPIOB
#define NRF2_IRQ_GPIO_PORT     GPIOB
#define NRF2_IRQ_GPIO_PIN      GPIO_Pin_12


#define NRF2_CSN_HIGH()        GPIO_SetBits(NRF2_CSN_GPIO_PORT,NRF2_CSN_GPIO_PIN)
#define NRF2_CSN_LOW()         GPIO_ResetBits(NRF2_CSN_GPIO_PORT,NRF2_CSN_GPIO_PIN)
#define NRF2_CE_HIGH()         GPIO_SetBits(NRF2_CE_GPIO_PORT,NRF2_CE_GPIO_PIN)
#define NRF2_CE_LOW()          GPIO_ResetBits(NRF2_CE_GPIO_PORT,NRF2_CE_GPIO_PIN)
#define NRF2_Read_IRQ()        GPIO_ReadInputDataBit(NRF2_IRQ_GPIO_PORT,NRF2_IRQ_GPIO_PIN)
