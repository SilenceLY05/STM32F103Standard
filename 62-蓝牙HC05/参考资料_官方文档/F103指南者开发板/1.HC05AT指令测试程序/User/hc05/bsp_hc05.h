...
enum
{
  HC05_DEFAULT_TIMEOUT = 200,                        //默认超时时间
  HC05_INQUIRY_DEFAULT_TIMEOUT = 10000,              //查询默认超时时间
  HC05_PAIRING_DEFAULT_TIMEOUT = 10000,              //配对默认超时时间
  HC05_PASSWORD_MAXLEN = 16,                         //密码最大长度
  HC05_PASSWORD_BUFSIZE = HC05_PASSWORD_MAXLEN + 1,  //密码缓冲区大小
  HC05_NAME_MAXLEN = 32,                             //名字最大长度
  HC05_NAME_BUFSIZE = HC05_NAME_MAXLEN + 1,          //名字缓冲区字节
  HC05_ADDRESS_MAXLEN = 14,                          //地址最大长度
  HC05_ADDRESS_BUFSIZE = HC05_ADDRESS_MAXLEN + 1,    //地址缓冲区字节
};
