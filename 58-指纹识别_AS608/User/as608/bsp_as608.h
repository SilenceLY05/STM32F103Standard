...
#define PS_MAXNUM     240         /* 指纹模块最大存储指纹模版数 */
...
/** 
  ...
  */
/* 串口2-USART2 */
#define AS608_USARTx                         USART2
#define AS608_USART_CLK                      RCC_APB1Periph_USART2
#define AS608_USART_ClockCmd                 RCC_APB1PeriphClockCmd
#define AS608_USART_BAUDRATE                 57600

/* USART GPIO引脚宏定义 */
#define AS608_USART_GPIO_ClockCmd            RCC_APB2PeriphClockCmd
...
#define AS608_TouchOut_INT_EXTI_IRQHanlder   EXTI4_IRQHandler
