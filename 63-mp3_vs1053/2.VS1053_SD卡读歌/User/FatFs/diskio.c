...
)
{
	...
	case ATA :
		...
		SD_state = SD_ReadMultiBlocks(buff,(uint64_t)sector*SD_BLOCK_SIZE,SD_BLOCK_SIZE,count);
...
)
{
	...
	case ATA :
		...
		SD_state = SD_ReadMultiBlocks((uint8_t *)buff,(uint64_t)sector*SD_BLOCK_SIZE,SD_BLOCK_SIZE,count);
