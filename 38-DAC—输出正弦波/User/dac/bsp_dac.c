...
static void DAC_TIM_Config(void)
{
	...
	/* TIM2通用定时器配置 */
	TIM_TimeBaseInitStructure.TIM_Period = (20-1);                   //定时周期 20  
	TIM_TimeBaseInitStructure.TIM_ClockDivision = 0x0;               //时钟分频系数
	TIM_TimeBaseInitStructure.TIM_CounterMode = TIM_CounterMode_Up;  //向上计数模式
	TIM_TimeBaseInitStructure.TIM_Prescaler = 0x0;                   //预分频，不分频 72M / (0+1) = 72M
